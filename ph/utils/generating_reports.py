...
from ph.utils.entity_extraction import extract_entities
from ph.utils.data_retrieving import get_articles_for_assessment
...
def generate_risk_assessment_report(query: str) -> str:
    '''
    This function generates risk assessment report based on query
    Args:
        query
    Returns:
    ...
    articles = get_articles_for_assessment(entities)

    report = generate_reports(text = articles, action = "risk assessment")
    return report